  ...
  data() {
    return {
      ...
      configKeys: [
        ...
        {
          key: "region",
          value: "The region where your DigitalOcean bucket is located",
          type: "string",
          required: true,
          info: {text: '', link: ''}
        },
        ...
        {
          key: "bucket",
          value: "The name of your DigitalOcean Bucket container where the files will be stored",
          type: "string",
          required: true,
          info: {text: '', link: ''}
        },
    ...
    configBase() {
      return {
        spaces_storage: {
          ...
          bucket: "nyc3",
          endpoint: "https://nyc3.fra1.digitaloceanspaces.com"
        }
      }
    }
  },
